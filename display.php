...
$connect->query("ALTER TABLE `google_users` ADD COLUMN mentor_name varchar(20)");
$connect->query("UPDATE `google_users` SET selected=0 WHERE google_name='Abhinav Khare' ");/*
